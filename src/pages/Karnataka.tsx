              ...
              <Card className="border-0 bg-gradient-to-br from-red-50 to-red-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    ...
                    <li className="flex items-center p-2 bg-white/50 rounded">⚖️ High Court at Bengaluru</li>
              ...
              <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    ...
                    <li className="flex items-center p-2 bg-white/50 rounded">🏛️ Assembly Seats: 224</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏢 Lok Sabha Seats: 28</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">📍 Polling Stations: ~58,000</li>
          ...
          <TabsContent value="economy" className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="border-0 bg-gradient-to-br from-green-50 to-green-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">☕ Coffee & Tea</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🧵 Silk & Cotton</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🌶️ Spices & Cashews</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🍚 Rice & Ragi</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🌱 Floriculture</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">💻 IT & Biotechnology</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">✈️ Aerospace</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🚗 Automobiles</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🔌 Electronics</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏗️ Infrastructure</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">💎 Gold (Kolar)</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🪨 Iron Ore</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🔩 Manganese</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🧂 Limestone</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">⛏️ Bauxite</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
