          ...
          <TabsContent value="politics" className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="border-0 bg-gradient-to-br from-red-50 to-red-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">🏢 SKM Government</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">⚖️ High Court at Gangtok</li>
              ...
              <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">🗳️ Total Voters: ~4.3 Lakh</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏛️ Assembly Seats: 32</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏢 Lok Sabha Seats: 1</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">📍 Polling Stations: ~500</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
          ...
          <TabsContent value="economy" className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="border-0 bg-gradient-to-br from-green-50 to-green-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">🌿 Cardamom (Queen of Spices)</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🍊 Mandarin Oranges</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🍵 Temi Tea</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🌱 Organic Vegetables</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">💧 Major rivers: Teesta, Rangit</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏗️ Several hydroelectric projects</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🔌 Power exporter to other states</li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl transition-all">
                ...
                <CardContent>
                  <ul className="space-y-3 text-sm">
                    <li className="flex items-center p-2 bg-white/50 rounded">🖼️ Thangka paintings</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🧶 Woolen carpets</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🪵 Wood carvings</li>
                    <li className="flex items-center p-2 bg-white/50 rounded">🏺 Handmade paper</li>
                  </ul>
                </CardContent>
              </Card>
            </div>
